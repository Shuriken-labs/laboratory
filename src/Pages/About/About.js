...
import Partner1 from '../../assets/Artificial Intelligence Logo.png';
import Partner2 from '../../assets/5 of the most iconic graphic designers – Gorilla Food & Drink Brand Design Agency 1.png';
import Partner3 from '../../assets/Brain logo, molecule, dna _ Medical logo design 1.png';
import Partner4 from '../../assets/Lumin Logo & Brand identitiy.png';
import Partner5 from '../../assets/Find the best global talent_ (1).png';
import Partner6 from '../../assets/Human AI Tech Logo.png';
import Partner7 from '../../assets/Vortex logo.png';
	...
	return (
		<div>
			...
			<div className="mt-[7rem]">
				<h2 className="_irish p-4 md:p-0 text-3xl __shuriken_labs">We’re building a transparent Web3 Academy</h2>
			...
			<div className="mt-[7rem]">
				...
				<div className="mt-[5rem] grid grid-cols-2 md:flex items-center justify-center gap-[4rem] md:gap-0">
					<div className="mx-14">
						...
						<p className="text-white _montserrat text-sm md:text-2xl uppercase">Register</p>
					</div>
					<div className="mx-14">
					...
					<div className="mx-14">
						...
						<p className="text-white _montserrat text-sm md:text-2xl">Find Course</p>
					</div>
					<div className="mx-14">
						<h2 className="_irish __shuriken_labs text-6xl mb-3">4</h2>
						<p className="text-white _montserrat text-sm md:text-2xl">Start Learning</p>
					</div>
				</div>
			</div>
			<div className="mt-[7rem]">
				<div>
					<h1 className="__shuriken_labs _irish text-4xl md:text-5xl">Top Instructors</h1>
				</div>
			...
			<div className="mt-[7rem]">
				...
				<div className="grid grid-cols-5 items-center justify-center gap-3 mt-[2rem] px-8 md:px-[13rem]">
					<div className="">
						<img src={Partner3} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner5} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner10} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner6} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner2} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem] " />
					</div>
					<div className="">
						<img src={Partner7} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner4} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner1} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner8} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
					<div className="">
						<img src={Partner9} alt="" className="h-[4rem] md:h-[7rem] md:w-[7rem]" />
					</div>
				</div>
			</div>
			<div className="md:mt-[7rem] mt-[4rem] __about_footer ">
				<div className="pt-[13rem] items-center justify-center">
					...
					<div className="flex items-center justify-center relative">
						<input type="email" placeholder='Subscribe' className="md:h-[2.6rem] md:w-[37rem] h-[3rem] w-[20rem] rounded-full mdrounded-lg hover:outline-none _montserrat" />
