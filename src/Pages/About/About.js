    ...
    <div>
      <div>
        <div className="md:mt-8 mt-[5rem]">
          <h1 className="__shuriken_labs _irish text-5xl md:text-6xl">
            SHURIKEN LABS?
          </h1>
        ...
        <div className="md:flex items-center justify-center gap-7 md:m-0 mt-[6rem]">
          <div className="__ninja_border_design w-[17rem] md:w-[9.3rem] md:mx-0 mx-auto">
            <img
              src={SecondNinja}
              alt=""
              className=" mx-[3rem] md:mx-0 md:h-[17rem] md:w-[9rem]"
            />
          </div>
      ...
      <div className="mt-[7rem]">
        ...
        <p className="text-white _montserrat px-7 md:px-[17rem] mt-4">
          ...
          pellentesque dolor sed nulla fringilla sodales. Sed dapibus molestie
          faucibus. Ut sodales dolor non erat accumsan, at aliquam urna
          consectetur. Donec ullamcorper, erat non efficitur pellentesque,
          lectus magna imperdiet ante, ut facilisis justo odio nec nisi.
          Vestibulum orci sapien, auctor id tincidunt id, maximus eu lectus.
          Quisque vitae vehicula sapien. Aenean ex dolor, auctor quis nisl
          vitae, pellentesque lobortis ipsum.
        </p>
      </div>
      ...
      <div className="mt-[7rem]">
        ...
        <div className="mt-[5rem] grid grid-cols-2 md:flex items-center justify-center gap-[4rem] md:gap-0">
          <div className="mx-14">
            ...
            <p className="text-white _montserrat text-sm md:text-2xl">
              Connect Wallet
            </p>
          </div>
          <div className="mx-14">
        ...
        <div className="md:flex items-center justify-center gap-7 mt-[2rem]">
          ...
          <div className="__ninja_background_design p-4 md:h-[17rem] h-[23rem] w-[17rem] md:w-[12rem] md:mx-0 mx-auto my-7 md:my-0">
            <img
              src={SeventhNinja}
              alt=""
              className="h-[16.9rem] w-[14rem] md:h-[11rem] md:w-[11rem]"
            />
            <div className="mt-3">
      ...
      <div className="mt-[7rem]">
        <div>
          <h1 className="__shuriken_labs _irish md:text-5xl text-4xl">
            Partners
          </h1>
        </div>
      ...
      <div className="md:mt-[7rem] mt-[4rem] __about_footer ">
        <div className="pt-[13rem] items-center justify-center">
          <h1 className="_irish md:text-5xl text-3xl mb-2 text-white">
            Subscribe to Newsletter
          </h1>
          <p className="text-white _montserrat md:mb-2 mb-9">
