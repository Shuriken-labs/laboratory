	...
	return (
		<div className="my-8">
			<div className="relative">
				...
				<img src={youtubeicon} alt="" className="absolute md:top-[9rem] top-[9rem] left-[10rem] md:left-[40rem] h-[2rem]" />
			</div>
			<div>
					...
					<div className="md:flex items-center justify-center gap-7 mt-[2rem]">
						...
						<div className="__course_background_design ">
							<div className="__courses_card2">
								<img src={Coursesimg2} alt="" className="h-[11rem] w-[11rem] " />
							</div>
							<div className="mt-3">
						...
						<div className="__course_background_design ">
							<div className="__courses_card3">
								...
								<img src={Courselock} alt="" className="absolute top-[4rem] left-[4rem]" />
							</div>
							<div className="mt-3">
								<h2 className="_irish  text-white text-xl ">Bash Fundamentals</h2>
						...
						<div className="__course_background_design ">
							...
							<div className="mt-3">
								<h2 className="_irish  text-white text-xl">JavaScript Sensei</h2>
								<button className="__courses_button _irish"> UNLOCK </button>
							</div>
						</div>
					</div>
